...
Pour jouer en local, cloner le projet, installer composer si nécessaire, puis lancer un 'composer install' , et renseigner le infos de bdd dans le dossier app/config.ini
